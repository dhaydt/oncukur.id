...
class ChattingController extends Controller
{
    ...
    {
        $shop_id = auth('mitra')->user()->shop_id;

        $last_chat = Chatting::where(['shop_id' => $shop_id, 'mitra_id' => auth('mitra')->id()])
        ...
        if (isset($last_chat)) {
            ...
            return view('mitra-views.chatting.chat', compact('chattings', 'chattings_user', 'last_chat'));
        }

        return view('mitra-views.chatting.chat', compact('last_chat'));
    }
