...
<div class="product-card card pb-3 {{$product['current_stock']==0?'stock-card':''}}">
    {{-- @if($product['current_stock']<=0) <label style="left: 29%!important; top: 29%!important;"
        ...
        <div class="card-header inline_product clickable" style="cursor: pointer;max-height: 127px;min-height: 127px">
        ...
        <div class="card-body inline_product text-center p-1 clickable d-flex flex-column justify-content-between"
