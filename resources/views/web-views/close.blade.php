                ...
                <div class="card">
                    @if(auth('customer')->check())
                        <div class=" p-5">
                            ...
                            <span class="font-weight-bold d-block mt-4" style="font-size: 17px;">{{\App\CPU\translate('Hello')}}</span>
                            <span>{{\App\CPU\translate('You order has been confirmed, and payyed successfully! Please back to application')}}</span>

                            {{-- <div class="row mt-4">
                                <div class="col-6">
                                    <a href="{{route('home')}}" class="btn btn-primary">
                                        {{\App\CPU\translate('back_home')}}
                                    </a>
                                </div>
