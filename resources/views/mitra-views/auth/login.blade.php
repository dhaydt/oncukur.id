...
<body>
    <!-- ========== MAIN CONTENT ========== -->
    <main id="content" role="main" class="main" style="text-align: {{Session::get('direction') === " rtl" ? 'right'
        : 'left' }};">
            ...
            <div class="row justify-content-center">
                <div class="col-md-7 col-lg-5">
                    ...
                    <div class="card card-lg mb-5">
                        <div class="card-body">
                            <!-- Form -->
                            <form class="js-validate" action="{{route('mitra.auth.login.store')}}" method="post">
                                @csrf
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <center>
                                            <h1 class="h4 text-gray-900 mb-4">
                                                {{\App\CPU\translate('welcome_back_to_mitra_login')}}</h1>
                                        </center>
                                    </div>
                                    {{--<a class="btn btn-lg btn-block btn-white mb-4" href="#">
                                        <span class="d-flex justify-content-center align-items-center">
                                            <img class="avatar avatar-xss mr-2"
                                                src="{{asset('assets/admin')}}/svg/brands/google.svg"
                                ...
                                <div class="js-form-message form-group">
                                    ...
                                    <input type="email" class="form-control form-control-lg" name="email"
                                        id="signinSrEmail" style="text-align: {{Session::get('direction') === " rtl"
                                        ? 'right' : 'left' }};" tabindex="1" placeholder="email@address.com"
