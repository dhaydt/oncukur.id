...
@section('content')
    ...
    <div class="content container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                <form action="{{route('mitra.profile.update',[$data->id])}}" method="post"
                    ...
                    <div class="card mb-3 mb-lg-5" id="generalDiv">
                        ...
                        <label
                            ...
                            <img id="viewer"
                                ...
                                class="avatar-img"
                                name="ktp"
                                src="{{asset('storage/mitra')}}/{{$data->image}}"
                                alt="Image">
                        </label>
                        <!-- End Avatar -->
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-9 row">
                                    <div class="col-md-12">
                                        <label for="name">{{\App\CPU\translate('Full')}} {{\App\CPU\translate('Name')}} <span
                ...
                <div id="passwordDiv" class="card mb-3 mb-lg-5">
                    ...
                    <div class="card-body">
                        <!-- Form -->
                        <form id="changePasswordForm" action="{{route('mitra.profile.settings-password')}}"
                            method="post"
...
@push('script_2')
    ...
    <script>
        var thumbnail = '{{asset('storage/ktp').'/'.$data->ktp??asset('assets/back-end/img/160x160/img1.jpg')}}';
        $(function () {
