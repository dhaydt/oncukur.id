                                ...
                                @foreach($chattings_user as $key => $chatting)
                                    <div class="chat_list @if ($key == 0) active @endif"
                                        ...
                                        <div class="chat_people" id="chat_people">
                                            ...
                                            <div class="chat_ib">
                                                <h5 class="seller text-capitalize @if($chatting->seen_by_seller)active-text @endif"
                                        ...
                                        @foreach($chattings as $key => $message)
                                            @if ($message->sent_by_customer)
                                                <div class="incoming_msg d-flex">
                                                    <div class="incoming_msg_img d-flex justify-content-center">
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#msgSendBtn").click(function (e) {
                ...
                $.ajax({
                    type: "post",
                    url: '{{route('mitra.messages.seller_message_store')}}',
                    data: data,
