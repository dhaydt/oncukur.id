            ...
            <div class="col-md-6">
                <div class="card border-0 box-shadow">
                    <div class="card-body">
                        ...
                        <p class="font-size-sm text-muted mb-4">{{\App\CPU\translate('register_to_found_best_barbershop')}}
                            .</p>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label for="reg-fn">{{\App\CPU\translate('Name')}}</label>
                                        <input class="form-control" value="{{old('name')}}" type="text" name="name"
                                               style="text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};"
                                               required>
                                        <div class="invalid-feedback">{{\App\CPU\translate('Please enter your name')}}!</div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="reg-phone required">{{\App\CPU\translate('phone_number')}}</label>
