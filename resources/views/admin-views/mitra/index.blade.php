...
@section('title', \App\CPU\translate('Mitra List'))
                    ...
                    <div class="card-header">
                        <div class="row row justify-content-between align-items-center flex-grow-1 mx-1">
                            <div class="flex-between">
                                <div><h5>{{\App\CPU\translate('mitra_table')}}</h5></div>
                        ...
                        <div class="table-responsive">
                            <table
                                ...
                                <tr>
                                    ...
                                    <th scope="col">{{\App\CPU\translate('bookings')}}</th>
                                    ...
                                    <tr>
                                        ...
                                        <td scope="col">
                                            <a href="{{route('admin.sellers.product-list',[$seller['id']])}}"
                                                class="btn btn-outline-primary btn-block">
                                                <i class="tio-premium-outlined mr-1"></i>Bookings
                                            </a>
                                        </td>
                                        <td>
                                            <a class="btn btn-primary"
                                                href="{{route('admin.mitras.view',$seller->id)}}">
